...
class CharacIdCatalog private constructor(
    ...
    companion object {
         ...
         * ramp can plausibly read as its *source* are mapped; anything else resolves to null (forced-only). Stable
         * strings, so this is a small name correspondence — NOT a hand-maintained id table.
         */
